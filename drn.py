...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=3, channels=(16, 32, 64, 128, 256, 512, 512, 512), out_map=False, out_middle=False, pool_size=28, arch='D'):
    ...
    def _make_conv_layers(self, channels, convs, stride=1, dilation=1):
        ...
        for i in range(convs):
            modules.extend([nn.Conv2d(self.inplanes, channels, kernel_size=3, stride=stride if i == 0 else 1, padding=dilation, bias=False, dilation=dilation), BatchNorm(channels),
